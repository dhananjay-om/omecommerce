...
/** Shared by ListWebsites, UpdateWebsiteTaxSettings, and
 *  UpdateWebsiteGeneralSettings — all three read/write the same Website row
 *  and need the identical view shape, including the live-resolved logoUrl
 *  (never cached/stored, same as every other presigned URL in this codebase). */

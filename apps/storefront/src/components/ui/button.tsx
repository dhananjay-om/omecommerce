...
const buttonVariants = cva(
  // ÉLUME restyle: rounded-full (pill) base, matching the reference theme's
  // buttons — xs/sm/icon-xs/icon-sm sizes below still override with their
  // own smaller radius via tailwind-merge, this only changes the default.

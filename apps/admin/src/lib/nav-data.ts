...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: 'analytics-marketing', label: 'Marketing Analytics', href: '/reports/marketing', icon: Megaphone, status: 'live',
        description: 'Coupon redemption and referral funnel performance.',
      },
      {
        key: 'analytics-financial', label: 'Financial Analytics', href: '/reports/financial', icon: Wallet, status: 'live',
        description: 'Tax, payment mix, refunds, and outstanding liability/receivables.',
      },
      {
        key: 'reports-builder', label: 'Reports', href: '/reports/builder', icon: ClipboardList, status: 'live',
        description: 'Pick a metric and a date range, run it, export CSV, save it for later.',
      },
    ],
  },
  {
